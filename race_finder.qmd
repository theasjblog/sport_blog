---
title: "Race Finder"
description: "Search the race archive by date, type, distance, and report availability."
page-layout: full
...
This is the structured archive view of the site. Use it when you want to jump straight to a race report or the deeper race-analysis app without browsing the narrative archive page by page.
:::
...
race_metadata <- dbGetQuery(con, 
                            glue("SELECT EVENT_DATE, EVENT_NAME, EVENT_TYPE, EVENT_DISTANCE, RACE_ID
