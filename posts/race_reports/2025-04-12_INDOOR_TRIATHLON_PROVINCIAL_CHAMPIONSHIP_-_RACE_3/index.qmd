...
description: "Race 3 of the indoor provincial championship series, with a better bike, a stronger run, and the age-group fight tightening."
...
analysis_data <- get_post_analysis_data(c('2025-04-12', '2025-02-22'))
race_metadata <- analysis_data$race_metadata
all_races <- analysis_data$all_races
activities_metadata <- analysis_data$activities_metadata
activities_data <- analysis_data$activities_data
