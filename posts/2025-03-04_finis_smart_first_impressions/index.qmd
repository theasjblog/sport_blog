...
![Finis Smart Swim Goggles](img/goggles.png)
...
![The goggles and the Ciye pod.](img/boxed.png)
...
![The Ciye pod in the left lens.](img/chip_in.png)
...
![News tab](img/news.png){ width="200" }
...
![Main settings screen](img/settings.png){ width="200" }

### Screen adjustments

![Screen adjustments](img/adjust_screen.png){ width="200" }
...
![Swim screen fields](img/fields.png){ width="200" }
