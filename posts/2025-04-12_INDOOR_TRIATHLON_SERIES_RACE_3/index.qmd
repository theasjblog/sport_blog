...
|            | Swim laps | Bike distance | Run laps |
|------------|-----------|---------------|----------|
| **Race 1** | 16.5      | 9             | 15       |
| **Race 3** | 15.5      | 10.6          | 16.5     |

The swim was disappointing. I felt like I was doing a good job. I swam the first few minutes trailing behind the other guy in my lane -which I think is the guy who finished second in the age group-, but then I passed him and kept the lead. Sure I was probably too conservative with my energy management, but I did not think I was being so conservative.

On the bike I felt good. Again I tried to not get too tired out, and this time I actually bike for the whole 15min, I did not start late. I do not recall exactly for how long I cycled in the first race, but let's say about 13min. That would be 9/13=0.69km/min. This time I did 10.6Km and I stopped at around 14:45, since I knew I could not do 400 more meters in 15seconds and get more points. That would be 10.6/14.75=0.72km/min. So a bit faster, maybe around 1Km/h faster.
...
In this race I finished 7$^{th}$ overall and 2$^{nd}$ in the Age Group. The guy that finished first was incredible: 21 swim laps (1050), 10.5Km on the bike, and 18.5 run laps (3.7Km). Just no way I can keep up with him, especially in the water.

![Age group ranking for Race 3](./img/02.png)

### Series ranking

The good news for me is that Paul did not do race 1, so he has no way to catch me in the series ranking, unless he will take part in race 4 and for reason I will not be able to. With that said, here is the ranking (male only).
...
This table now tells a few things:

* If Paul Shortins does not show up at the next race, I have a shot at the championship. Unlikely, but possible. Otherwise, no way I can close that gap of 395 points.
* For the Age Group championship, it is tight. I have a 53 points lead, and it does not take much to rack up more than 53 points: Swim 25m more, bike 500m more, run and 200m more, and you have collected 60 extra points. What gives me hope is that until now I always managed to outperform Nick in every sport -well, except the bike on the first race, but there he only covered 500m more, and I cycled for 2min less-. But you've never won until you crossed the finish line first!
